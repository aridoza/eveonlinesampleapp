...
class Footer extends React.Component {
  constructor(props) {
    ...
    this.onChange = this.onChange.bind(this);  //ES6 react components must have any internal methods use .bind when binding (this) context
    //React.createClass() was autobinding before in ES5
  }
