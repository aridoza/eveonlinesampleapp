...
class Navbar extends React.Component {
  ...
  componentWillUnmount() {
    NavbarStyle.unlisten(this.onChange);
  }
            ...
            <li className='dropdown'>
              ...
              <ul className='dropdown-menu'>
                ...
                <li className='dropdown-submenu'>
                  ...
                  <ul className='dropdown-menu'>
                    <li><Link to='/top/gallente/brutor'>Brutor</Link></li>
                    <li><Link to='/top/gallente/sebiestor'>Sebiestor</Link></li>
                    <li><Link to='/top/gallente/vherokior'>Vherokior</Link></li>
                  </ul>
                </li>
                <li className='dropdown-submenu'>
                  <Link to='/top/amarr'>Amarr</Link>
                  <ul className='dropdown-menu'>
                    <li><Link to='/top/gallente/amarr'>Amarr</Link></li>
                    <li><Link to='/top/gallente/ni-kunni'>Ni-Kunni</Link></li>
                    <li><Link to='/top/gallente/khanid'>Khanid</Link></li>
                  </ul>
                </li>
